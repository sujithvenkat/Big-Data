...
#Data in the first column has string, but it has to be integer, ensure that with the below function
...
#I realized null values in the key column, wanted to apply the constraint to fail my program incase if the structure is not fulfilled
